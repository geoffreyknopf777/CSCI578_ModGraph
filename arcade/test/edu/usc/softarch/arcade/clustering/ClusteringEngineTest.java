...
public class ClusteringEngineTest extends TestCase {
	...
	/*
	 * public void testClusteringEngine() { fail("Not yet implemented"); }
	 */
	...
	public void testSharedFeaturesMap() {
		...
		set1.add(fv1);
		set1.add(fv2);
		SimCalcUtil.sharedFeaturesMap.put(set1,
				SimCalcUtil.getNumSharedFeatures(fv1, fv2));
		...
		// System.out.println("SharedFeaturesMap contains key " + set1 + "  " +
		// ce.SharedFeaturesMap.containsKey(set1));
		// System.out.println("SharedFeaturesMap contains key " + set2 + "  " +
		// ce.SharedFeaturesMap.containsKey(set2));
		// System.out.println("SharedFeaturesMap contains key " + set3 + "  " +
		// ce.SharedFeaturesMap.containsKey(set3));
		...
		System.out.println("SimCalcUtil.SharedFeaturesMap.get(set1): "
				+ SimCalcUtil.sharedFeaturesMap.get(set1));
		System.out.println("SimCalcUtil.SharedFeaturesMap.get(set2): "
				+ SimCalcUtil.sharedFeaturesMap.get(set2));
		System.out.println("SimCalcUtil.SharedFeaturesMap.get(set3): "
				+ SimCalcUtil.sharedFeaturesMap.get(set3));

		SimCalcUtil.sharedFeaturesMap.put(set3,
				SimCalcUtil.getNumSharedFeatures(fv3, fv4));
	...
	public void testOneZeroFeaturesMap() {
		...
		pair1.add(fv1);
		pair1.add(fv2);
		SimCalcUtil.oneZeroFeaturesMap.put(pair1,
				SimCalcUtil.getNum10Features(fv1, fv2));
		System.out.println("SimCalcUtil.getNum10Features(fv1, fv2): "
				+ SimCalcUtil.getNum10Features(fv1, fv2));

		ArrayList<FeatureVector> pair2 = new ArrayList<FeatureVector>(2);
		pair2.add(fv2);
		pair2.add(fv1);
		SimCalcUtil.oneZeroFeaturesMap.put(pair2,
				SimCalcUtil.getNum10Features(fv2, fv1));
		System.out.println("SimCalcUtil.getNum10Features(fv2, fv1): "
				+ SimCalcUtil.getNum10Features(fv2, fv1));

		assertEquals(SimCalcUtil.getNum10Features(fv1, fv2),
				SimCalcUtil.oneZeroFeaturesMap.get(pair1).intValue());
		assertEquals(SimCalcUtil.getNum10Features(fv2, fv1),
				SimCalcUtil.oneZeroFeaturesMap.get(pair2).intValue());
	}
