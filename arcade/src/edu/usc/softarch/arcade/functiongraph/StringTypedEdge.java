...
public class StringTypedEdge extends StringEdge implements Serializable {
	...
	static Logger logger = org.apache.logging.log4j.LogManager.getLogger(StringTypedEdge.class);
	...
	public boolean equals(Object o) {
		...
		if (e.srcStr.equals(this.srcStr) && e.tgtStr.equals(this.tgtStr)
	...
	/**
	 * hashCode that combines two strings Source:
