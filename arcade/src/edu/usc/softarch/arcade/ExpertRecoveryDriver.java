...
public class ExpertRecoveryDriver {
	static Logger logger = org.apache.logging.log4j.LogManager.getLogger(ExpertRecoveryDriver.class);
	...
	public static void main(final String[] args) {
		...
		try {
			...
			if (line.hasOption("help")) {
				...
				formatter.printHelp(ExpertRecoveryDriver.class.getName(),
						options);
				System.exit(0);
			}
		...
		ExpertDecompositionBuilder
		.readInExpertDecomposition("/home/joshua/recovery/Expert Decompositions/Bash expert decompositions.txt");
		ExpertDecompositionBuilder
		.buildExpertDecompositionClusters(RsfReader.startNodesSet);
