...
public class ConcernComparator extends SimMeasureComparator implements
	...
	public int compare(Cluster c1, Cluster c2) {
		...
		if (c2.docTopicItem == null || refCluster.docTopicItem == null
				|| c1.docTopicItem == null) {
			return Integer.MAX_VALUE;
		}
		...
		int returnValue = concernMeasureC2.compareTo(SimCalcUtil
				.getJSDivergence(c2, refCluster));
		if (DEBUG) {
			System.out.println("\tConcernComparator's return value: "
					+ returnValue);
		}
