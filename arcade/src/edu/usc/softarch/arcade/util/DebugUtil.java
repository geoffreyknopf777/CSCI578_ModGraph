...
public class DebugUtil {
	static Logger logger = org.apache.logging.log4j.LogManager.getLogger(DebugUtil.class);
	...
	public static String addMethodInfo(String s) {
		return "In, " + Thread.currentThread().getStackTrace()[1].getMethodName() + ", " + s;
	}

	public static String convertByteArrayOutputStreamToString(ByteArrayOutputStream sourceStream) {
	...
	public static void checkIntraPairSize(HashSet<String> intraPair, String element1, String element2) {
		if (intraPair.size() != 2) {
