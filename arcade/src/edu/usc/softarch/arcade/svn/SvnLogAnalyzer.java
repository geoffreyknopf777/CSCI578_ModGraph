...
public class SvnLogAnalyzer {
	static Logger logger = org.apache.logging.log4j.LogManager.getLogger(SvnLogAnalyzer.class);
	...
	public static void main(final String[] args) {
		 ...
		 * Default values:
		 */
		String url = "http://svn.apache.org/repos/asf/hadoop/common/tags/release-0.20.2"; // for
																							// older
																							// hadoop
																							// svn
																							// log
		// String url = "http://svn.apache.org/repos/asf/hadoop/common/trunk";
		// // for newer hadoop svn log
		...
		for (final Object element : logEntries) {
			/*
			 * gets a next SVNLogEntry
			 */
			final SVNLogEntry logEntry = (SVNLogEntry) element;
			logger.debug("---------------------------------------------");
			/*
			...
			if (logEntry.getChangedPaths().size() > 0) {
				...
				for (final Iterator<?> changedPaths = changedPathsSet.iterator(); changedPaths
						.hasNext();) {
					/*
					 * obtains a next SVNLogEntryPath
					 */
					final SVNLogEntryPath entryPath = logEntry
